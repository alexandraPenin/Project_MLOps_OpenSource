...
def get_requirements(file_path:str)->List[str]:
    ...
    with open(file_path) as file_obj:
        requirements=file_obj.readlines()# read each line of the file_obj // readlines() - returns the complete file as a "list of strings each separated by \n"
